...
@Default
public class BoardsDBRepository implements BoardRepository {
...
//		this.em.find(Account.class, foundAcc.ge)
	...
	public List<Board> findBoardByBoardID(int userID) {
		TypedQuery<Board> query = this.em.createQuery("SELECT b FROM Board b WHERE a.account.id = :id",
				Board.class);
